...
public class MeshGenerationNode : TerrainNode
{
    ...
    [Input] public float[] TerrainColorNoiseMap = null;
    ...
    public override void Recalculate()
    {
        ...
        TerrainColorNoiseMap = GetInputValue("TerrainColorNoiseMap", this.SedimentMap);
    }
    ...
    public MapData GetValueAsMapData()
    {
        ...
        mapData.TerrainColorNoiseMap = new SquareArray<float>(TerrainColorNoiseMap);
