...
public class MapData
{
    ...
    [SerializeField]
    public SquareArray<float> TerrainColorNoiseMap;
    ...
    public MapData Clone()
    {
        MapData other = new MapData
        {
            ...
            SedimentMap = SedimentMap.Clone() as SquareArray<float>,
            TerrainColorNoiseMap = TerrainColorNoiseMap.Clone() as SquareArray<float>,
        };
